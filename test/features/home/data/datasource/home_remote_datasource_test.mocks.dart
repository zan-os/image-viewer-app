...
// in unsplash_flutter/test/features/image_list/data/datasource/image_list_remote_datasource_test.dart.
...
class _FakeTransformer_3 extends _i1.SmartFake implements _i4.Transformer {
  _FakeTransformer_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class _FakeResponse_5<T1> extends _i1.SmartFake implements _i6.Response<T1> {
  _FakeResponse_5(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockDio extends _i1.Mock implements _i9.Dio {
  ...
  _i7.Future<_i6.Response<T>> head<T>(
    ...
    _i10.CancelToken? cancelToken,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i7.Future<_i6.Response<T>>.value(_FakeResponse_5<T>(
          this,
          Invocation.method(
            #head,
            [path],
  ...
  _i7.Future<_i6.Response<dynamic>> download(
    ...
    _i3.Options? options,
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _i7.Future<_i6.Response<dynamic>>.value(_FakeResponse_5<dynamic>(
          this,
          Invocation.method(
            #download,
            [
  ...
  @override
  _i7.Future<_i6.Response<T>> fetch<T>(_i3.RequestOptions? requestOptions) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetch,
          [requestOptions],
